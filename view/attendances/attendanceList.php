<div id="page">
    ...
    <div class="tbl-content">
        <table cellpadding="0" cellspacing="0" border="0">
            <tbody>
            <?php
            /** @var \model\AttendanceView $attendance */
            $total_time = 0;
            if (isset($attendances)) {
                foreach ($attendances as $attendance) { ?>
                    <tr>
                        <?php if (isset($users) && $users == true) echo ' <td>' . $attendance->getUserName() . '</td>' ?>
                        <td><?= $attendance->getDateIn(); ?></td>
                        ...
                        <td><?php
                            ...
                            $total_time += $time;
                            echo $attendance->getWorkTime()->format("%h:%I");
                            ?>
                        </td>
