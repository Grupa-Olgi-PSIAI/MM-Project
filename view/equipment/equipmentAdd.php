<div id="page">
    <form action="<?= '/' . ROUTE_EQUIPMENT . '/' . ACTION_CREATE ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="material-input">
            <input type='text' id="purchase_date" name='purchase_date' required onfocus="(this.type='date')"
        ...
        <div class="material-input">
            <input type='text' id="serial_number" name='serial_number'
                   title="dowolna liczba całkowita" required/>
            <span class="material-input-highlight"></span>
            <span class="material-input-bar"></span>
        ...
        <div class="material-input">
            <input type='text' id="validation_date" name='validation_date' required onfocus="(this.type='date')"
                   onblur="(this.type='text')"/>
            <span class="material-input-highlight"></span>
            <span class="material-input-bar"></span>
